...
```{r echo=FALSE}
table(qda.class[[1]], df[subsets==1, 1], dnn=c("QDA Predicted", "Actual"))
kfoldpercentages = vector()
for (i in 1:nfolds){
  kfoldpercentages = c(kfoldpercentages, sum(qda.class[[i]]==df[subsets==i,1])/length(qda.class[[i]]))
}
```
